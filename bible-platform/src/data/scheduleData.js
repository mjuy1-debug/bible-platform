...
export const SAMPLE_EVENTS = [
  ...
  { id: 4, title: '부활절 전교인 야유회', date: '2026-04-12', time: '10:00', category: 'church', description: '부활절 기념 전교인 친교 행사' },
  { id: 5, title: '어린이 주일', date: '2026-05-03', time: '11:00', category: 'church', description: '어린이 주일 특별예배' },
  { id: 6, title: '어버이 주일', date: '2026-05-10', time: '11:00', category: 'church', description: '어버이 주일 감사예배' },
  { id: 7, title: '맥추감사절 예배', date: '2026-07-05', time: '11:00', category: 'church', description: '맥추감사절 특별 감사예배' },
  { id: 8, title: '추수감사절 예배', date: '2026-11-15', time: '11:00', category: 'church', description: '추수감사절 감사예배 및 바자회' },
  { id: 9, title: '전교인 체육대회', date: '2026-11-08', time: '10:00', category: 'church', description: '가을 전교인 체육대회' },
  { id: 10, title: '대림절 시작', date: '2026-11-29', time: '11:00', category: 'church', description: '대림절 첫째 주일' },
  { id: 11, title: '성탄절 예배', date: '2026-12-25', time: '11:00', category: 'church', description: '성탄 축하 예배 및 성극' },
  { id: 12, title: '송구헌신예배', date: '2026-12-31', time: '23:00', category: 'church', description: '2026년 송구헌신예배' },
  { id: 13, title: '송구영신예배', date: '2026-12-31', time: '23:00', category: 'church', description: '송구영신 예배' },
  { id: 14, title: '제 14차 필리핀선교지 방문', date: '2026-03-16', endDate: '2026-03-20', category: 'church', description: '제 14차 필리핀선교지 방문' },
  { id: 15, title: '1/4분기 선교헌신예배', date: '2026-03-22', category: 'church', description: '1/4분기 선교헌신예배' },
  { id: 16, title: '교회본당 대청소', date: '2026-03-28', category: 'church', description: '교회본당 대청소' },
  { id: 17, title: '수양관 밭갈이', date: '2026-03-29', category: 'joshua', description: '수양관 밭갈이' },
  { id: 18, title: '부활주일(계란전도대회)', date: '2026-04-05', category: 'church', description: '부활주일(계란전도대회)' },
  { id: 19, title: '주일학교일일수련회', date: '2026-04-18', category: 'joshua', description: '주일학교일일수련회,차량봉사' },
  { id: 20, title: '루디아나들이', date: '2026-04-26', category: 'joshua', description: '루디아나들이,차량봉사' },
];
